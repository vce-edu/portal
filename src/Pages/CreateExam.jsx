                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            ...
                                            <div className="flex items-center gap-2 flex-shrink-0">
                                                ...
                                                <Button
                                                    size="sm"
                                                    variant="secondary"
                                                    className="opacity-0 group-hover:opacity-100 transition-all bg-yellow-50 text-yellow-600 hover:bg-yellow-100 border-none shadow-none"
                                                ...
                                                <Button
                                                    size="sm"
                                                    variant="danger"
                                                    className="opacity-0 group-hover:opacity-100 transition-all border-none font-bold"
